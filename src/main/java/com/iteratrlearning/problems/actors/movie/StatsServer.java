...
import com.iteratrlearning.answers.actors.movie.InfoMovieMessage;
import com.iteratrlearning.answers.actors.movie.ViewMovieMessage;
    ...
    public Route createRoute() {
        ...
        Route watchRoute =
                parameter("movie", movieName -> {
                    ...
                    return complete("Movie has been seen!");
                });
